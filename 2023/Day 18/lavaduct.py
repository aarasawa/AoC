...
When viewed from above, the above example dig plan would result in the following loop of trench (#) having been dug out from 
...
.######
.######
Now, the lagoon can contain a much more respectable 62 cubic meters of lava. While the interior is dug out, the edges are 
also painted according to the color codes in the dig plan.

The Elves are concerned the lagoon won't be large enough; if they follow their dig plan, how many cubic meters of lava 
could it hold?

reference:https://www.reddit.com/r/adventofcode/comments/18l0qtr/comment/kdv18dn/
interesting competition to decrease the size LOL
"""

plan = list(map(str.split, open('lavaduct_input.txt')))
