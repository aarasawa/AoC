...
module a processes its pulse and sends more pulses, the pulses sent to modules b and c would have to be handled first.
...
Each of these modules is a flip-flop module (as indicated by the % prefix). a outputs to b which outputs to c which 
outputs to another module named inv. inv is a conjunction module (as indicated by the & prefix) which, 
...
The multi-input conjunction module con watches the two flip-flop modules and, if they're both on, sends a low pulse to the 
output module.
...
reference: https://github.com/sayan01/advent-of-code-2023/blob/master/11/p.py
"""

from itertools import combinations as comb
L = [x.strip() for x in open('path_input.txt')]
